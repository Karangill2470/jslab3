...
let person = 
{
    ...
    greetings: function () 
    {
        alert(`Hello there, am ${this.name.firstName}`);
    },
    bio: function () 
    {
        return `${this.name.firstName} ${this.name.lastName}, of age ${this.age}, and gender ${this.gender} is interested in ${this.interests.join(", ")}`;
    }
...
{
    alert(`This is ${this.name.firstName} logging off, goodbye!`);
}
